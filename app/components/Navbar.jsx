...
export default function Navbar() {
    ...
    return (        <nav className="fixed top-0 left-0 w-full flex justify-between items-center p-4 px-6 md:px-10 lg:px-16 bg-[#84B] text-white z-50">
            ...
            <div className="hidden md:flex ml-auto gap-6 lg:gap-8">
